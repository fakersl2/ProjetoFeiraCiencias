                ...
                <div className="flex flex-nowrap items-center justify-around max-w-screen-xl p-4 mx-auto">
                    <div className='flex flex-nowrap md:flex-wrap'>
                        <a target="_blank" href="http://colegiocomercialcpv.com.br/"
                            className="flex items-center space-x-3 rtl:space-x-reverse transition-all hover:scale-105 hover:mx-2" rel="noreferrer">
                            <img src={Logo} alt="Logo" className="w-auto h-12" />
                            <p
                                className="text-wrap block px-3 py-2 text-gray-900 md:hover:bg-transparent md:hover:text-green-700 md:p-0 md:dark:hover:text-green-500 ">
                                Colégio Comercial de Caçapava
                            </p>
                        </a>
                        <a href="/inicio"
                            className="flex items-center space-x-3 rtl:space-x-reverse transition-all hover:scale-105 sm:ml-2 md:ml-6" rel="noreferrer">
                            <p
                                className="text-wrap block px-3 py-2 text-gray-900 md:hover:bg-transparent md:hover:text-green-700 md:p-0 md:dark:hover:text-green-500 hover:underline decoration-green-800">
                                Início
                            </p>
                        </a>
                    </div>
